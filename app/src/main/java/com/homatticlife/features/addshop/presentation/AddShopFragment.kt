package com.homatticlife.features.addshop.presentation
...
import com.homatticlife.features.dashboard.presentation.ShopVerificationDialog
import com.homatticlife.features.dashboard.presentation.VisitRemarksTypeAdapter
...
import com.homatticlife.features.login.model.GetQtsAnsSubmitDtlsResponseModel
...
import com.homatticlife.features.viewAllOrder.interf.QaOnCLick
...
//                    showStageDialog(list)
            ...
            /*R.id.tv_frag_add_shop_add_contact1 ->{
                Toaster.msgShort(mContext,System.currentTimeMillis().toString())
                ...
                fab_add.setOnClickListener({ view ->
                    Toaster.msgShort(mContext,et_contactName.text.toString())
                })
