package com.homatticlife.features.login.presentation
...
import com.homatticlife.CustomStatic
import com.homatticlife.R
import com.homatticlife.app.*
import com.homatticlife.app.AlarmReceiver.Companion.setAlarm
import com.homatticlife.app.domain.*
import com.homatticlife.app.utils.*
import com.homatticlife.app.utils.AppUtils.Companion.getCurrentTimeInMintes
...
import com.homatticlife.features.activities.model.*
import com.homatticlife.features.addAttendence.FingerprintDialog
import com.homatticlife.features.addAttendence.SelfieDialog
import com.homatticlife.features.addshop.api.areaList.AreaListRepoProvider
import com.homatticlife.features.addshop.api.assignToPPList.AssignToPPListRepoProvider
import com.homatticlife.features.addshop.api.assignedToDDList.AssignToDDListRepoProvider
import com.homatticlife.features.addshop.api.typeList.TypeListRepoProvider
import com.homatticlife.features.addshop.model.*
import com.homatticlife.features.addshop.model.TypeListResponseModel
import com.homatticlife.features.addshop.model.assigntoddlist.AssignToDDListResponseModel
import com.homatticlife.features.addshop.model.assigntopplist.AssignToPPListResponseModel
import com.homatticlife.features.alarm.model.AlarmData
import com.homatticlife.features.beatCustom.BeatGetStatusModel
import com.homatticlife.features.beatCustom.api.GetBeatRegProvider
import com.homatticlife.features.billing.api.billinglistapi.BillingListRepoProvider
import com.homatticlife.features.billing.model.BillingListResponseModel
...
import com.homatticlife.features.dashboard.presentation.api.dayStartEnd.DayStartEndRepoProvider
import com.homatticlife.features.dashboard.presentation.api.gteroutelistapi.GetRouteListRepoProvider
import com.homatticlife.features.dashboard.presentation.model.SelectedRouteListResponseModel
import com.homatticlife.features.dashboard.presentation.model.StatusDayStartEnd
import com.homatticlife.features.document.api.DocumentRepoProvider
import com.homatticlife.features.document.model.DocumentListResponseModel
import com.homatticlife.features.document.model.DocumentTypeResponseModel
import com.homatticlife.features.forgotpassword.presentation.ForgotPasswordDialog
import com.homatticlife.features.location.LocationWizard
import com.homatticlife.features.location.SingleShotLocationProvider
...
import com.homatticlife.features.location.model.VisitRemarksResponseModel
...
import com.homatticlife.features.login.UserLoginDataEntity
import com.homatticlife.features.login.api.LoginRepositoryProvider
import com.homatticlife.features.login.api.alarmconfigapi.AlarmConfigRepoProvider
import com.homatticlife.features.login.api.global_config.ConfigFetchRepoProvider
import com.homatticlife.features.login.api.productlistapi.ProductListRepoProvider
import com.homatticlife.features.login.api.user_config.UserConfigRepoProvider
import com.homatticlife.features.login.model.*
import com.homatticlife.features.login.model.alarmconfigmodel.AlarmConfigResponseModel
import com.homatticlife.features.login.model.globalconfig.ConfigFetchResponseModel
import com.homatticlife.features.login.model.mettingListModel.MeetingListResponseModel
import com.homatticlife.features.login.model.productlistmodel.ModelListResponse
import com.homatticlife.features.login.model.productlistmodel.NewOdrScrOrderListModel
import com.homatticlife.features.login.model.productlistmodel.ProductListOfflineResponseModelNew
import com.homatticlife.features.login.model.productlistmodel.ProductListResponseModel
import com.homatticlife.features.login.model.userconfig.UserConfigResponseModel
import com.homatticlife.features.meetinglist.api.MeetingRepoProvider
import com.homatticlife.features.member.api.TeamRepoProvider
import com.homatticlife.features.member.model.TeamAreaListResponseModel
import com.homatticlife.features.member.model.UserPjpResponseModel
import com.homatticlife.features.nearbyshops.api.ShopListRepositoryProvider
import com.homatticlife.features.nearbyshops.model.*
import com.homatticlife.features.newcollection.model.NewCollectionListResponseModel
import com.homatticlife.features.newcollection.model.PaymentModeResponseModel
import com.homatticlife.features.newcollection.newcollectionlistapi.NewCollectionListRepoProvider
import com.homatticlife.features.orderList.api.neworderlistapi.NewOrderListRepoProvider
import com.homatticlife.features.orderList.model.NewOrderListResponseModel
import com.homatticlife.features.orderList.model.ReturnListResponseModel
import com.homatticlife.features.quotation.api.QuotationRepoProvider
...
import com.homatticlife.features.stock.api.StockRepositoryProvider
import com.homatticlife.features.stock.model.NewStockListResponseModel
import com.homatticlife.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.homatticlife.features.stockAddCurrentStock.model.CurrentStockGetData
import com.homatticlife.features.stockCompetetorStock.api.AddCompStockProvider
import com.homatticlife.features.stockCompetetorStock.model.CompetetorStockGetData
import com.homatticlife.features.task.api.TaskRepoProvider
import com.homatticlife.features.task.model.TaskListResponseModel
import com.homatticlife.features.timesheet.api.TimeSheetRepoProvider
import com.homatticlife.features.timesheet.model.TimeSheetConfigResponseModel
import com.homatticlife.features.timesheet.model.TimeSheetDropDownResponseModel
import com.homatticlife.features.viewAllOrder.api.OrderDetailsListRepoProvider
import com.homatticlife.features.viewAllOrder.model.NewOrderDataModel
import com.homatticlife.features.viewPPDDStock.api.stocklist.StockListRepoProvider
import com.homatticlife.features.viewPPDDStock.model.stocklist.StockListDataModel
import com.homatticlife.features.viewPPDDStock.model.stocklist.StockListResponseModel
    ...
    private fun getMeetingList() {
        ...
        BaseActivity.compositeDisposable.add(
                repository.meetingList()
                        ...
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val response = result as com.homatticlife.features.meetinglist.model.MeetingListResponseModel
                            if (response.status == NetworkConstant.SUCCESS) {
    ...
    private fun getTypeApi() {
        ...
        BaseActivity.compositeDisposable.add(
                repository.typeList()
                        ...
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val response = result as com.homatticlife.features.activities.model.TypeListResponseModel
                            if (response.status == NetworkConstant.SUCCESS) {
                                val list = response.type_list
    ...
    fun openShareDB(dbpath:String) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
                currentDBPath="/data/user/0/com.homatticlife/databases/fts_db"
            }
