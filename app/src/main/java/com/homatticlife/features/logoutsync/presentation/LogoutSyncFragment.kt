package com.homatticlife.features.logoutsync.presentation
...
import com.homatticlife.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.homatticlife.features.addshop.api.AddShopRepositoryProvider
import com.homatticlife.features.billing.api.AddBillingRepoProvider
import com.homatticlife.features.billing.model.AddBillingInputParamsModel
...
import com.homatticlife.features.dashboard.presentation.ReasonDialog
...
import com.homatticlife.features.document.model.AddEditDocumentInputParams
import com.homatticlife.features.document.model.DocumentAttachmentModel
...
import com.homatticlife.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.homatticlife.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.homatticlife.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.homatticlife.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.homatticlife.features.orderhistory.model.*
...
import com.homatticlife.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.homatticlife.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.homatticlife.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.homatticlife.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.homatticlife.features.timesheet.model.AddTimeSheetInputModel
import com.homatticlife.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.homatticlife.features.viewAllOrder.model.AddOrderInputParamsModel
import com.homatticlife.features.viewAllOrder.model.AddOrderInputProductList
import com.homatticlife.mappackage.SendBrod
import com.homatticlife.widgets.AppCustomTextView
import com.homatticlife.MonitorService
import com.homatticlife.features.addshop.model.*
import com.homatticlife.features.addshop.model.assigntopplist.AddShopUploadImg
import com.homatticlife.features.login.api.LoginRepositoryProvider
import com.homatticlife.features.login.model.GetConcurrentUserResponse
import com.homatticlife.features.returnsOrder.ReturnProductList
import com.homatticlife.features.returnsOrder.ReturnRequest
import com.homatticlife.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhomatticlifelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhomatticlifelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhomatticlifelogsample/log.zip").path);
